/*
  ============================================================
  Controlador Modbus NR9000 + Nokia 5110
  ============================================================
  Autor: Esteban P.A.
  ...
  Los datos se muestran en una pantalla Nokia 5110 y el
  ESP32 proporciona además una interfaz web mediante Wi-Fi.
  ...
  Nota:
  GPIO21 controla la dirección del transceptor RS485:
    HIGH = Transmisión
    LOW  = Recepción

  Entrada RX del ESP32:
  El pin RO del MAX485 se adapta mediante divisor resistivo
  para proteger la entrada de 3,3 V del ESP32:
